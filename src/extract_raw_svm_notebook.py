"""
Extract and run the raw SVM classification notebook to generate figures and metadata.
"""
import json

NOTEBOOK_PATH = '/mnt/libraries/pola/notebooks/pola_raw_svm_classification.ipynb'
OUTPUT_SCRIPT = '/mnt/libraries/pola/notebooks/run_raw_svm_with_exports.py'
